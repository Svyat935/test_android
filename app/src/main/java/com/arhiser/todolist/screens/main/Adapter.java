...
public class Adapter extends RecyclerView.Adapter<Adapter.NoteViewHolder> {
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Note note) {
            ...
            noteText.setText(note.name);

            Timestamp date_ = new Timestamp(note.date);
            timeText.setText(date_.toString());
        ...
        private void updateStrokeOut() {
            if (note.done) {
                ...
                timeText.setPaintFlags(noteText.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
            } else {
                noteText.setPaintFlags(noteText.getPaintFlags() & ~Paint.STRIKE_THRU_TEXT_FLAG);
                timeText.setPaintFlags(noteText.getPaintFlags() & ~Paint.STRIKE_THRU_TEXT_FLAG);
            }
